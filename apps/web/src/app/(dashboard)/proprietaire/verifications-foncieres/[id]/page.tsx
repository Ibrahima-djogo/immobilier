...
export default function OwnerFonciereVerificationDetailPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) {
          setRequest(
            next && requestBelongsToOwner(next, DEMO_OWNER_ID) ? next : null,
          );
        }
      } finally {
  ...
  return (
    <>
      <OwnerPageHeader
        ...
        backHref={routes.ownerFonciereVerifications}
      ...
      {!loaded ? (
        ...
        <section className={styles.empty}>
          ...
          <Button href={routes.ownerFonciereVerifications} variant="secondary">
            Retour à la liste
          </Button>
        </section>
      ) : (
