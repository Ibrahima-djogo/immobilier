...
export const ownerProperties: OwnerProperty[] = [
  {
    ...
    description:
      "Villa spacieuse et lumineuse avec jardin, stationnement, groupe électrogène et réservoir d’eau.",
  },
  {
    id: "p2",
    ...
    videos: [],
    description:
      "Appartement récent dans une résidence calme, avec séjour lumineux, cuisine moderne et parking.",
  },
  {
    id: "p3",
    ...
    videos: [],
    description:
      "Terrain résidentiel accessible, dossier à compléter avant création de l’annonce.",
  },
];
...
export const ownerAds: OwnerAd[] = [
  ...
  },
  {
    ...
    rejectionReason:
      "Le prix et la description ne correspondent pas aux informations du bien rattaché.",
  },
];
...
export const ownerContacts: OwnerContact[] = [
  {
    ...
    message:
      "Bonjour, je souhaite visiter cette villa samedi matin. Pouvez-vous me confirmer une heure disponible ?",
    status: "NOUVEAU",
  ...
  },
  {
    ...
    message:
      "Je souhaite connaître les conditions de location et le montant de la caution.",
    status: "EN_COURS",
