...
export default function RegistrationPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
     ...
     * L’unicité e-mail/téléphone doit être contrôlée côté serveur.
     */
  ...
  function handleVerification(event: FormEvent<HTMLFormElement>) {
    ...
    /*
     * Aperçu front-end seulement :
     * la vérification réelle sera effectuée par l’API.
     */
    setVerificationMessage("");
    setStep("success");
  }
      ...
      <section className={styles.authSection}>
        <aside className={styles.visualPanel}>
          ...
          <div className={styles.visualContent}>
            ...
            <h1>
              Créez votre espace immobilier <span>en toute simplicité.</span>
            </h1>

            <p className={styles.visualDescription}>
              Enregistrez vos favoris, suivez vos demandes et accédez
              progressivement aux services de Demeure Guinée.
            </p>

            <div className={styles.stepsList}>
              {[
                ["1", "Créer un compte standard", "Renseignez vos informations personnelles et vos coordonnées."],
                ["2", "Vérifier vos coordonnées", "Un code temporaire confirmera votre e-mail ou votre téléphone."],
                ["3", "Accéder à votre espace", "Retrouvez vos favoris et suivez vos demandes de contact."],
          ...
          <div className={styles.formContainer}>
            {step === "form" && (
              <>
                ...
                <div className={styles.formHeading}>
                  ...
                  <p>
                    Rejoignez Demeure Guinée pour enregistrer vos favoris et
                    suivre vos activités immobilières.
                  </p>
                </div>
            ...
            {step === "verification" && (
              <div className={styles.stateCard}>
                ...
                <p>
                  Lors de l’intégration de l’API, un code temporaire sera envoyé
                  à vos coordonnées.
                </p>
            ...
            {step === "success" && (
              <div className={styles.stateCard}>
                ...
                <span className={styles.stateEyebrow}>Aperçu de l’état final</span>
                <h2>Compte prêt à être activé</h2>
                <p>
                  Cette démonstration confirme uniquement le parcours front-end.
                  Aucun compte réel n’a été créé sans l’API Spring Boot.
                </p>
                ...
                <Link href="/connexion" className={styles.submitButton}>
