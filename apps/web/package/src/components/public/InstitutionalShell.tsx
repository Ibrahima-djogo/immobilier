      ...
      <header className={styles.header}>
        <div className={styles.container}>
          ...
          <div className={styles.headerActions}>
            ...
            <Link href="/inscription" className={styles.register}>Créer un compte</Link>
      ...
      {open && (
        <>
          ...
          <aside className={styles.mobileMenu}>
            ...
            <Link href="/aide" onClick={() => setOpen(false)}>Centre d’aide</Link>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerMain}>
          <div className={styles.footerBrand}>
            ...
            <p>Une plateforme immobilière pensée pour faciliter la recherche de biens et renforcer la confiance entre utilisateurs et annonceurs vérifiés.</p>
            <span className={styles.trust}><ShieldCheck size={17} />Profils professionnels contrôlés</span>
          </div>
