    ...
    <InstitutionalShell>
      <section className={styles.hero}>
        <div className={styles.container}>
          <span className={styles.icon}><Scale size={25} /></span>
        ...
        <div className={styles.container}>
          <aside className={styles.warning}>
            ...
            <p>
              ...
              durées de conservation et mentions obligatoires doivent être validés
              pour le pays de déploiement avant la mise en production.
            </p>
          </aside>
